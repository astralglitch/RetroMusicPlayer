...
/** The Podcasts-world counterpart of [CategoryInfoAdapter] -- same drag-to-reorder/checkbox
 * mechanism, kept as a separate class rather than generalized since [PodcastCategoryInfo] is
 * intentionally a distinct model from [code.name.monkey.retromusic.model.CategoryInfo] (see
 * that class's doc). */
class PodcastCategoryInfoAdapter : RecyclerView.Adapter<PodcastCategoryInfoAdapter.ViewHolder>(),
    ActionCompletionContract {
    var categoryInfos: MutableList<PodcastCategoryInfo> =
        PreferenceUtil.podcastCategory.toMutableList()
    ...
    private fun isLastCheckedCategory(categoryInfo: PodcastCategoryInfo): Boolean {
